...
CREATE SEQUENCE IF NOT EXISTS "data"."data_seq" AS integer;
ALTER SEQUENCE IF EXISTS "data"."data_seq" AS bigint;
ALTER TABLE dic."Region" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."CityType" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."SettelmentType" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."RegionType" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Address" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."StreetType" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Store" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Terminal" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Products" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Price" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."ProductUnit" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."ProductCategory" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."PaymentType" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Role" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE dic."Cashier" ALTER COLUMN "ID" SET DEFAULT nextval('dic.dic_seq'::regclass);
ALTER TABLE data."ChequeType" ALTER COLUMN "ID" SET DEFAULT nextval('data.data_seq'::regclass);
ALTER TABLE data."Shift" ALTER COLUMN "ID" SET DEFAULT nextval('data.data_seq'::regclass);
ALTER TABLE data."Cheque" ALTER COLUMN "ID" SET DEFAULT nextval('data.data_seq'::regclass);
ALTER TABLE data."ChequePositions" ALTER COLUMN "ID" SET DEFAULT nextval('data.data_seq'::regclass);
ALTER TABLE data."ChequePayment" ALTER COLUMN "ID" SET DEFAULT nextval('data.data_seq'::regclass);