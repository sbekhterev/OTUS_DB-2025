...
DECLARE
	...
	required_keys text[] := ARRAY['Name', 'Unit', 'EAN', 'Category', 'Price', 'PriceStart', 'PriceEnd'];
	required_key text;
	missing_keys text[];
BEGIN
...
LOOP
	...
	--- Вставляем Цены
	RAISE NOTICE '%, %, %, %', return_product_id, product_price, price_start_date, price_end_date;
	INSERT INTO dic."Price" ("ProductId", "Price", "StartDate", "EndDate")
	VALUES (return_product_id, product_price, price_start_date, price_end_date);
