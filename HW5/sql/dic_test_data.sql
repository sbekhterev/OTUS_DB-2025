...
INSERT INTO "ProductCategory" ("CategoryName", "ParentCategory" ) VALUES
('Лопаты', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Плиты', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Горшки', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Молотки', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Ключи гаечные', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Тиски', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Штучный товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары')));
INSERT INTO "ProductCategory" ("CategoryName", "ParentCategory" ) VALUES
('Гвозди', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Гайки', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Винты', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Саморезы', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Шайбы', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары'))),
('Воздух', (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Весовой товар' AND pc."ParentCategory" = (SELECT "ID" FROM "ProductCategory" pc WHERE pc."CategoryName" = 'Непродовольственные товары')));
